...
procedure ForwardFFT(const Source: PComplexArray; const Dest: PComplexArray; Count: integer);
...
procedure InverseFFT(const Source: PComplexArray; const Dest: PComplexArray; Count: integer);
...
procedure ReorderSeries(Count: integer; var Factors: TIdx1FactorArray; var Remain: TIdx0FactorArray;
	const X: PComplexArray; var Y: PComplexArray);
var
  i, j, k: integer;
...
procedure SynthesizeFFT(Sofar, Radix, Remain: integer; Y: PComplexArray);
var
