...
begin
  ...
  begin
    ...
    GetThemeColor(ThemeServices.Theme[teListView], LVP_LISTITEM, LIS_NORMAL,
       TMT_FILLCOLOR, LColorRef);
...
const
  States: array[Boolean, Boolean] of Cardinal = ((HIS_NORMAL, HIS_PRESSED),
    (HIS_HOT, HIS_PRESSED));
var
