...
uses SysUtils,
	uProjectVersion, uStrings;

var
	FirstContext    : Boolean = True;
...
var
	Buffer: AnsiString;
	ProjectVersion: TProjectVersion;
...
begin
	...
	begin
		ProjectVersion := CreateVersion(ReadToChar(PAnsiChar(glGetString(GL_VERSION)), CharSpace), nil);

		GL_VERSION_1_0 := (ProjectVersion.Major >= 2) or ((ProjectVersion.Major = 1));
		GL_VERSION_1_1 := (ProjectVersion.Major >= 2) or ((ProjectVersion.Major = 1) and (ProjectVersion.Minor >= 1));
		GL_VERSION_1_2 := (ProjectVersion.Major >= 2) or ((ProjectVersion.Major = 1) and (ProjectVersion.Minor >= 2));
	end;
	...
	begin
		ProjectVersion := CreateVersion(ReadToChar(PAnsiChar(gluGetString(GLU_VERSION)), CharSpace), nil);
		GLU_VERSION_1_1 := (ProjectVersion.Major >= 2) or ((ProjectVersion.Major = 1) and (ProjectVersion.Minor >= 1));
		GLU_VERSION_1_2 := (ProjectVersion.Major >= 2) or ((ProjectVersion.Major = 1) and (ProjectVersion.Minor >= 2));
	end;

  // check supported extensions
  // -- first GL
	Buffer:=PAnsiChar(glGetString(GL_EXTENSIONS));
  ...
  // -- second GLU
	Buffer:=PAnsiChar(gluGetString(GLU_EXTENSIONS));
